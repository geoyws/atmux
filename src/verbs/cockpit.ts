...
export interface ReconcileCockpitOpts {
  ...
  topology?: GroupedTopology;
  /** ADR-281 deterministic scheduler singleton. Per-team additive
...
export async function reconcileCockpitSession(
  ...
  // ADR-281: `_superbot` is a deterministic process window, not an
...
/** ADR-281: command for the cockpit scheduler window. The config path is
