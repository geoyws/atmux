...
| T4 | `src/abstractions/martinets/cursor.ts` (composer-2-fast, Tier 2 cage) + unit tests | T2 | be |
...
| T7 | e2e — synthetic cockpit with CursorMartinet + 1hr cycle + lead-token-burn assertion (<30k Opus/hr) | T4, T5, T6 | test |
