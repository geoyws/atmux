...
**Status**: proposed (deferred: gated on ADR-202 substrate + ADR-203 taxonomy landing first — jury consumes `story.tested` and emits `story.jury.*` per the taxonomy)
**Date**: 2026-05-21
