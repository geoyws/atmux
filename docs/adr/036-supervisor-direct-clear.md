...
**Status**: accepted (George 14:13 MYT 2026-05-08 — partially implemented in `src/core/send.ts` verify-mode + `src/verbs/stop.ts` modal-stuck handling; remaining work folds into HC#4 live-status of historical decision number 068 (no surviving ADR file))
**Date**: 2026-04-30
