...
**Status**: proposed (deferred: gated on Honker substrate ADR + impl — wizard's "install Honker extension" step depends on the substrate ADR landing first)
**Date**: 2026-05-20
