...
**Status**: accepted (George 14:13 MYT 2026-05-08 — promoted to substrate-level pre-req per historical decision number 068 (no surviving ADR file) cross-references + pubsub-first directive 13:27 MYT)
**Date**: 2026-04-27
