...
**Status**: Superseded by [ADR-289](289-poke-retirement.md) on 2026-09-23 — poke is retired, so whip-driven auto-stop has no driver. Retained below for historical trace.
