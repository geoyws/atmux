...
> **Superseded 2026-09-08.** Everything in this section describes the invariant as it was ratified. The operator revoked it; drivers now receive the two-stage shell-then-TUI launch like every other agent pane. Read on for history only.
