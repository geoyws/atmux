...
### Held `_superbot` role (ADR-281)

ADR-281 implements a deterministic scheduler window immediately after optional `_medic`, but the checked-in migration plan keeps activation held:
