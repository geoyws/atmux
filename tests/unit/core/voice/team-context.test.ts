// Unit tests for src/core/voice/team-context.ts — ADR-272 team index +
...
import {
  ...
  resolveTeamName,
  type VoiceTeamIndex,
} from "../../../../src/core/voice/team-context.ts";
...
describe("buildTeamIndex", () => {
  ...
  test("default loader reads the cockpit.json ATMUX_COCKPIT_CONFIG points at", async () => {
    const dir = await mkdtemp(join(tmpdir(), "atmux-voice-cockpit-"));
