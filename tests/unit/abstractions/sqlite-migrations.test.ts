...
describe("sqlite-migrations live ladder", () => {
  test("opening with the full ladder advances user_version to the tail (v14)", () => {
    ...
    //   - v13→v14 added spawn_queue for orchd refuse-then-queue path
    //             (ADR-228 §D2, t-095190f8) — TODO_FAN_IN_RENUMBER if
    //             sibling EPIC e-cf8a6195 (ADR-225) lands the slot first
...
// ---------- v13 → v14 — spawn_queue (ADR-228 §D2, TODO_FAN_IN_RENUMBER) ----------

describe("v13 → v14: spawn_queue (ADR-228 §D2, t-095190f8)", () => {
