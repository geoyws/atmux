...
// v6→v7 `refusal_events` ladder is tested here directly so future
...
describe("sqlite-migrations live ladder", () => {
  test("opening with the full ladder advances user_version to the tail (v7)", () => {
