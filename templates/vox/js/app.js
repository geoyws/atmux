// atmux vox — client state machine (ADR-272 D5/D8/D11).
//
// One WebSocket to `atmux vox`: binary frames = PCM16LE 24 kHz audio
...
import { decodeFrame, encodeFrame, nextSeq, VOICE_CLOSE, VOX_PROTOCOL } from "./protocol.js";
...
function sendTurnEnd() {
  ...
  ws.send(
    encodeFrame({
      flags: VOX_PROTOCOL.FLAG_TURN_END,
      seq: state.seq,
